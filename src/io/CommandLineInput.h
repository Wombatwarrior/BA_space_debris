...
private:
   ...
   * #input_file_name, #input_file_type, #output_file_name and #output_file_type
  ...
  std::string input_file_name =
      "input"; /**< Holds the complete file name of the input file*/
  FileInput::Type input_file_type =
      FileInput::TXT; /**< Holds the type of the input file*/
  std::string output_file_name =
      "output"; /**< Holds the complete file name of the output file*/
  FileOutput::Type output_file_type =
      FileOutput::TXT; /**< Holds the type of the output file*/
public:
  /**
