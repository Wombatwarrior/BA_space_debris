...
public:
  ...
  FileInput(Debris::DebrisContainer &debris_arg,
            std::string input_file_name_arg, Type input_file_type_arg)
      : debris(&debris_arg), input_file_name(input_file_name_arg),
...
private:
   ...
   * @return FileInput::TxtLineContent struct holding the result of splitting up
   * the line
   */
