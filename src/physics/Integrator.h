...
public:
  ...
  Integrator(Debris::DebrisContainer &debris_arg,
             ...
             double delta_t_arg)
      : debris(&debris_arg), accumulator(accumulator_arg),
        delta_t(delta_t_arg){};
   ...
   * Debris::Debris::velocity vector of the last time step of the Debris::Debris
   * objects of the Debris::DebrisContainer #debris it is called before
   * Integrator::calculateVelocity()
   */
  void integrate();
   ...
   *
   * Calls the Acceleration::AccelerationAccumulator::applyComponents() function
   * of the Acceleration::AccelerationAccumulator object #accumulator After this
   * function is called the Debris::Debris objects of the
