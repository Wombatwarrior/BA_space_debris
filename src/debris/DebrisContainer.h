...
namespace Debris {
    ...
    public:
         ...
         *
         * Creates a nwe DebrisContainer object and initializes the #debris_vector empty
         */
        DebrisContainer();
         ...
         *
         * Remove all Debris objects from the #debris_vector by calling it's clear() function
         *
         */
    ...
    private:
        ...
        std::vector<Debris> debris_vector;/**< std::vector holding the Debris objects this DebrisContainer objects holds */
    public:
        /**
