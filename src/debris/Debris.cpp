...
std::array<double, 3> &Debris::getPosition() { return position; }

void Debris::setPosition(std::array<double, 3> &position) {
  Debris::position = position;
}

std::array<double, 3> &Debris::getVelocity() { return velocity; }

void Debris::setVelocity(std::array<double, 3> &velocity) {
  Debris::velocity = velocity;
}

std::array<double, 3> &Debris::getAccT0() { return acc_t0; }

void Debris::setAccT0(std::array<double, 3> &accT0) { acc_t0 = accT0; }

std::array<double, 3> &Debris::getAccT1() { return acc_t1; }

void Debris::setAccT1(std::array<double, 3> &accT1) { acc_t1 = accT1; }
